...
<html>
<head>
	<title>Sandip University | Nashik</title>
	<link rel="shortcut icon" href="./Images/download1.jpg" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/download1.jpg" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">Sandip University</h3>
	</a>
